...
import { getStoreBySlug, getProductsByStore, Product, formatNumber } from "@/app/data/products";
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.storeHeader}>
          ...
          <div className={styles.logoContainer}>
            {store.logo ? (
              ...
              <span className={styles.logoPlaceholder} style={{ fontSize: "2.5rem" }}>
        ...
        <section className={styles.storeBioSection}>
          <div className={styles.bioContent}>
            ...
            {store.bannerMessage && (
              <p className={styles.bioText} style={{ fontStyle: "italic", borderLeft: "3px solid var(--color-palm)", paddingLeft: "1rem" }}>
                "{store.bannerMessage}"
              </p>
            )}
          </div>
          ...
          <div className={styles.statsSidebar}>
            <h3 className={styles.sectionTitle} style={{ fontSize: "1.05rem" }}>Store Details</h3>
            
            <div className={styles.statRow}>
              <span className={styles.statLabel}>Products Listed</span>
              <span className={styles.statValue}>{rawProducts.length} items</span>
            </div>
        ...
        <section className={styles.inventoryHeader}>
          <h2 className={styles.sectionTitle}>Shop the Catalog ({filteredProducts.length})</h2>
        ...
        {categoriesList.length > 0 && (
          <div className={styles.tabsContainer}>
            ...
            {categoriesList.map((cat) => {
              ...
              const count = filteredProducts.filter((p) => p.categorySlug === cat.slug).length;
              return (
                <button
                  key={cat.slug}
                  type="button"
