      ...
      <div className={styles.modal}>
        ...
        <div className={styles.modalBody}>
          <p style={{ fontSize: 14, color: "#6b6540", marginBottom: 16 }}>
            Rejecting{" "}
            <strong style={{ color: "#282600" }}>{productTitle}</strong>.
            Provide a reason for the seller.
          </p>
        ...
        <td>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              {product.brand && (
                <div style={{ fontSize: 11, color: "#9e9970" }}>
                  {product.brand}
                </div>
              )}
            </div>
        ...
        <td>
          <label className={styles.toggle}>
            <input
              ...
              onChange={() =>
                handleToggle(product._id, "featured", !!product.isFeatured)
              }
        ...
        <td>
          <label className={styles.toggle}>
            <input
              ...
              onChange={() =>
                handleToggle(product._id, "sponsored", !!product.isSponsored)
              }
            ...
            {product.status === "pending" && (
              <>
                ...
                <button
                  ...
                  onClick={() =>
                    setRejectTarget({ id: product._id, title: product.title })
                  }
...
export default function AdminProductsPage() {
  ...
  const handleToggle = useCallback(
    async (
      ...
      if (field === "featured")
        await setFeatured({ productId, isFeatured: !current });
              ...
              return (
                ...
                >
                  ...
                  {count !== null && count !== undefined && count > 0 && (
                    <span className={`${styles.tabCount} ${styles.pending}`}>
                      {count}
                    </span>
                  )}
                </button>
